...
<div style="text-align: center;">
	 <img class="image-reduced project-image" src="{{ site.baseurl }}/assets/images/projects/pixelated/ui-nov2015.png" alt=""/> 
...
<div style="text-align: center;">
	 <img class="image-reduced project-image" src="{{ site.baseurl }}/assets/images/projects/pixelated/sketching.JPG" alt=""/> 
...
<div style="text-align: center;">
	 <img class="image-reduced project-image" src="{{ site.baseurl }}/assets/images/projects/pixelated/pixelated-ui.gif" alt=""/> 
	 <figcaption>Some of the stages of the UI</figcaption>
 </div>
<br>

User research was mostly done guerilla style: we've done dozens of interviews to map and validate [the personas](https://pixelated-project.org/2015/07/15/personas/) we created, ran some usability testing on clickable mockups, then iteratively on running software. When we were able to launch a stable version for a few users to test, I've also built a simple feedback tool, which started providing many useful pieces of feedback that I started mapping.

<div style="text-align: center;">
	 <img class="image-reduced project-image" src="{{ site.baseurl }}/assets/images/projects/pixelated/threads-mockups.png" alt=""/> 
...
<div style="text-align: center;">
	 <img class="project-image" style="width: 60%;" src="{{ site.baseurl }}/assets/images/projects/pixelated/stickers-at-fisl.jpg" alt=""/> 
...
<div style="text-align: center;">
	 <img class="project-image" style="width: 50%;" src="{{ site.baseurl }}/assets/images/projects/pixelated/brand-sketches.png" alt=""/> 
...
<div style="text-align: center;">
	 <img class="project-image" style="width: 50%;" src="{{ site.baseurl }}/assets/images/projects/pixelated/website.png" alt=""/> 
